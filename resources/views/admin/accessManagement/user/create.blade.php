            ...
            <div class="row row-cards">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="{{ route('admin.roles.user.store') }}" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-md-8 col-12">
                                        <x-admin.input-text type="text" label="{{ __('User Name') }}" name="name" />
                                    </div>
                                    <div class="col-lg-6 col-md-8 col-12">
                                        <x-admin.input-text type="email" label=" {{ __('User Email') }}" name="email" />
                                    </div>
                                    <div class="col-lg-6 col-md-8 col-12">
