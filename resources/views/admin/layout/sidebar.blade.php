            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.profile.edit') ? 'active' : '' }}"
                        href="{{ route('admin.profile.edit', ['profile' => $admin->id]) }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.setting.edit', ['setting' => 88]) ? 'active' : '' }}"
                        href="{{ route('admin.setting.edit', ['setting' => 88]) }} ">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
