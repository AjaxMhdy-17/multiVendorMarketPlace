<footer class="footer-section " style="background: url({{ asset('assets/user/images/shapes/footer-bg.png')}});">
    <div class="container">
        <div class="subscription pt_55 pb_45" style="background: url({{ asset('assets/user/images/thumbs/subscrib_bg.jpg')}}">
        ...
        <div class="row gy-5">
            <div class="col-xl-3 col-sm-6">
                <div class="footer-widget">
                    <div class="footer-widget__logo">
                        <a href="index.html"> <img src="{{ asset('assets/user/images/logo/white-logo.png') }}"
                                alt=""></a>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 col-xs-6 ps-xl-5">
                <div class="footer-widget">
                    ...
                    <ul class="footer-lists">
                        ...
                        <li class="footer-lists__item"><a href="blog.html" class="footer-lists__link">Blog
                            </a>
                        </li>
            ...
            <div class="col-xl-4 col-sm-6">
                <div class="footer_widget_count">
                    ...
                    <div class="img">
                        <img src="{{ asset('assets/user/images/thumbs/pay_brand.png') }}" alt="Payment"
    ...
    <div class="bottom-footer">
        <div class="container container-two">
            <div class="bottom-footer__inner flx-between gap-3">
                <p class="bottom-footer__text font-14"> Copyright &copy; 2024 DigiMart, All rights reserved.
                </p>
