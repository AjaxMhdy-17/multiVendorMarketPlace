 <div class="dashboard-nav bg-white flx-between gap-md-3 gap-2">
     <div class="dashboard-nav__left flx-align gap-md-3 gap-2">
         ...
         <button type="button" class="icon-btn arrow-icon text-heading bg-gray-seven flx-center">
             <img src="{{ asset('assets/user/images/icons/angle-right.svg') }}" alt="">
         </button>
         <form action="#" class="search-input d-sm-block d-none">
             <span class="icon">
                 <img src="{{ asset('assets/user/images/icons/search-dark.svg') }}" alt=""
                     class="white-version">
                 <img src="{{ asset('assets/user/images/icons/search-dark-white.svg') }}" alt=""
                     class="dark-version">
             </span>
         ...
         <div class="header-right flx-align">
             <div class="header-right__inner gap-sm-3 gap-2 flx-align d-flex">
                 ...
                 <div class="user-profile">
                     <button class="user-profile__button flex-align">
                         <span class="user-profile__thumb">
                             <img src="{{ asset('assets/user/images/thumbs/user-profile.png') }}" class="cover-img"
                                 alt="">
                         </span>
                     </button>
                     <ul class="user-profile-dropdown">
                         <li class="sidebar-list__item">
                             <a href="dashboard-profile.html" class="sidebar-list__link">
                                 <span class="sidebar-list__icon">
                                     <img src="{{ asset('assets/user/images/icons/sidebar-icon2.svg') }}" alt=""
                                         class="icon">
                                     <img src="{{ asset('assets/user/images/icons/sidebar-icon-active2.svg') }}"
                         ...
                         <li class="sidebar-list__item">
                             <a href="setting.html" class="sidebar-list__link">
                                 <span class="sidebar-list__icon">
                                     <img src="{{ asset('assets/user/images/icons/sidebar-icon10.svg') }}"
                                         alt="" class="icon">
                                     <img src="{{ asset('assets/user/images/icons/sidebar-icon-active10.svg') }}"
                                         alt="" class="icon icon-active">
                                 </span>
                         ...
                         <li class="sidebar-list__item">
                             <a href="login.html" class="sidebar-list__link">
                                 <span class="sidebar-list__icon">
                                     <img src="{{ asset('assets/user/images/icons/sidebar-icon13.svg') }}"
                                         alt="" class="icon">
                                     <img src="{{ asset('assets/user/images/icons/sidebar-icon-active13.svg') }}"
                                         alt="" class="icon icon-active">
                                 </span>
                 ...
                 <div class="language-select flx-align select-has-icon">
                     <img src="{{ asset('assets/user/images/icons/globe.svg') }}" alt=""
                         class="globe-icon white-version">
                     <img src="{{ asset('assets/user/images/icons/globe-white.svg') }}" alt=""
