<section class="hero section-bg z-index-1">
    <img src="{{ asset('assets/user/images/gradients/banner-gradient.png') }}" alt=""
                        ...
                        <div class="position-relative">
                            <div class="search-box">
                                ...
                                <button type="submit" class="btn btn-main btn-icon icon border-0"><img
                                        src="{{ asset('assets/user/images/icons/search.svg') }}"
                                        alt=""></button>
                            </div>
            ...
            <div class="col-xl-3 col-12 col-md-6 col-lg-4">
                <div class="hero-thumb">
                    <ul class="direction_right">
                        <li><a href="#"><img src="{{ asset('assets/user/images/thumbs/product-img1.png') }}"
                                    alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('assets/user/images/thumbs/product-img2.png') }}"
                                    alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('assets/user/images/thumbs/product-img3.png') }}"
                                    alt="" /></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-3 col-12 col-md-6 col-lg-4 pt-5 sm_margin">
                <div class="hero-thumb">
                    <ul class="direction_left">
                        <li><a href="#"><img src="{{ asset('assets/user/images/thumbs/product-img4.png') }}"
                                    alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('assets/user/images/thumbs/product-img5.png') }}"
                                    alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('assets/user/images/thumbs/product-img6.png') }}"
                                    alt="" /></a></li>
                    </ul>
                </div>
            </div>
