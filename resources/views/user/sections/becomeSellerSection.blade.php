         ...
         <div class="row gy-4">
             <div class="col-lg-6">
                 <div class="seller-item position-relative z-index-1"
                     style="background: url({{ asset('assets/user/images/thumbs/seller-bg.png')}}">
                     <h3 class="seller-item__title">Earn 75% of the ItemD Price</h3>
                     <p class="seller-item__desc fw-500 text-heading">Sellers receive 75% of the Itemp Price
                         for
             ...
             <div class="col-lg-6">
                 <div class="seller-item bg-two position-relative z-index-1"
                     style="background: url({{ asset('assets/user/images/thumbs/seller-bg-two.png')}}">
