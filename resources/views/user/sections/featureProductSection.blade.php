             ...
             <div class="col-xl-5">
                 <div class="section-content featured_product_text">
                     <div class="section-heading">
                         ...
                         <p class="section-heading__desc font-18 w-sm">Every month we pick some best products
                             for
                 ...
                 <div class="row gy-4">
                     ...
                     <div class="col-sm-6 col-lg-4 col-xl-6">
                         <div class="product-item ">
                             <div class="product-item__thumb d-flex">
                                 <a href="product-details.html" class="link w-100">
                                     <img src="{{ asset('assets/user/images/thumbs/product-img3.png') }}"
                                         alt="" class="cover-img">
                                 </a>
                                 <button type="button" class="product-item__wishlist"><i
                                         class="fas fa-heart"></i></button>
                     ...
                     <div class="col-sm-6 col-lg-4 col-xl-6">
                         <div class="product-item ">
                             <div class="product-item__thumb d-flex">
                                 <a href="product-details.html" class="link w-100">
                                     <img src="{{ asset('assets/user/images/thumbs/product-img4.png') }}"
                                         alt="" class="cover-img">
                                 </a>
                                 <button type="button" class="product-item__wishlist"><i
                                         class="fas fa-heart"></i></button>
